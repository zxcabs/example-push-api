...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChatChatJs = __webpack_require__(1);
	
	var _ChatChatJs2 = _interopRequireDefault(_ChatChatJs);
	...
	window.onload = function () {
	  var chat = new _ChatChatJs2['default']('root');
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChatCss = __webpack_require__(2);
	
	var _ChatCss2 = _interopRequireDefault(_ChatCss);
	
	var _socketIoClient = __webpack_require__(6);
	
	var _socketIoClient2 = _interopRequireDefault(_socketIoClient);
	
	var consts = __webpack_require__(58);
	...
	var Chat = (function () {
	    function Chat() {
	        ...
	        var rootId = arguments[0] === undefined ? 'root' : arguments[0];
	        ...
	        this.socket = (0, _socketIoClient2['default'])('http://localhost/');
	        ...
	        navigator.serviceWorker.ready.then(function (serviceWorkerRegistration) {
	            return serviceWorkerRegistration.pushManager.getSubscription().then(function (pushSubscription) {
	                var isSubscribe = !!pushSubscription;
	
	                _this.isSubscribe = isSubscribe;
	                _this.subscribeButton.innerText = isSubscribe ? 'Unsubscribe' : 'Subscribe';
	            });
	        });
	    }
	    ...
	    _createClass(Chat, [{
	        key: 'chatTemplate',
	        value: function chatTemplate() {
	            return '<div class="' + _ChatCss2['default'].root + '">\n                    <div class="messages ' + _ChatCss2['default'].messages + '"></div>\n                    <div class="' + _ChatCss2['default'].control + '">\n                        <input class="newMessage ' + _ChatCss2['default'].newMessage + '"/>\n                        <button class="sendButton ' + _ChatCss2['default'].sendButton + '">Send</button>\n                        <button class="subscribeButton ' + _ChatCss2['default'].subscribeButton + '">Subscribe</button>\n                    </div>\n                </div>';
	        }
	    }, {
	        key: 'messageTemplate',
	        value: function messageTemplate(message) {
	            return '<div class="' + _ChatCss2['default'].message + ' ' + _ChatCss2['default'][message.type] + '">\n                    <div class="' + _ChatCss2['default'].messageTime + '">' + new Date(message.time).toLocaleTimeString() + '</div>\n                    <div class="' + _ChatCss2['default'].messageAuthor + '">' + message.author + ':</div>\n                    <div class="' + _ChatCss2['default'].messageText + '">' + message.text + '</div>\n                </div>';
	        }
	    }, {
	        key: 'onNewMessageKeyup',
	        value: function onNewMessageKeyup(ev) {
	            if (ev.keyCode === KEY_CODE_ENTER) {
	                this.processMessage();
	            }
	        }
	    }, {
	        key: 'onSendButtonClick',
	        value: function onSendButtonClick() {
	            this.processMessage();
	        }
	    }, {
	        key: 'onSubscribeButtonClick',
	        value: function onSubscribeButtonClick() {
	            if (this.isSubscribe) {
	                this.unsubscribe();
	            } else {
	                this.subscribe();
	        ...
	        value: function subscribe() {
	            ...
	            navigator.serviceWorker.register('/worker6.js').then(function () {
	                ...
	                _this2.isSubscribe = true;
	                _this2.subscribeButton.innerText = 'Unsubscribe';
	
	                _this2.socket.send({ type: consts.MSG_SUBSCRIBE, subscription: subscription });
	            })['catch'](function (error) {
	                console.error(error);
	            });
	        }
	        ...
	        value: function unsubscribe() {
	            ...
	            navigator.serviceWorker.ready.then(function (serviceWorkerRegistration) {
	                return serviceWorkerRegistration.pushManager.getSubscription().then(function (pushSubscription) {
	                    if (!pushSubscription) {
	                        _this3.isSubscribe = false;
	                        _this3.subscribeButton.innerText = 'Subscribe';
	                        _this3.socket.send({ type: consts.MSG_NOTSUBSCRIBE });
	                        return;
	                    }
	                    ...
	                    return pushSubscription.unsubscribe().then(function () {
	                        _this3.isSubscribe = false;
	                        _this3.subscribeButton.innerText = 'Subscribe';
	                        _this3.socket.send({ type: consts.MSG_UNSUBSCRIBE, subscriptionId: subscriptionId });
	                        return serviceWorkerRegistration.unregister().then(function (isUnregistered) {
	        ...
	        value: function processMessage() {
	            var newMessageText = (this.newMessageEl.value || '').trim();
	        ...
	        key: 'selfMessage',
	        value: function selfMessage(text) {
	            this.addMessage({
	                time: Date.now(),
	        ...
	        key: '_buildNode',
	        value: function _buildNode(html) {
...
/***/ function(module, exports) {
	...
	module.exports = {"root":"_2YfxPYWhGRTjHA-4j1jpcO","messages":"_1Qy_th6c9X9xTB5yLE7tfs","control":"_2YpcabuJx72MeqQCglBChB","newMessage":"_3BgPJ0D3hMJl-lRZR2vEXC","button":"_3fxqbI5EEYwqE5wAqjlQqF","sendButton":"_3jxCdRKbC8TXXq-P9XoH68 _3fxqbI5EEYwqE5wAqjlQqF","subscribeButton":"qoaXnEtnIYoDa42lZKesH _3fxqbI5EEYwqE5wAqjlQqF","message":"UfKSUt_A6LUNVZzJPZhmp","msg-system":"PTnonQvfypDpx8qdK_4Ng","messageTime":"_34brE-t8Ghy433eUiC4o8u","messageAuthor":"_1ksAmloyiIGagk898s9wOd"};
...
/***/ function(module, exports) {
	...
	module.exports = {
	    ...
	    MSG_UNSUBSCRIBE: 'msg-unsubscribe',
	    MSG_NOTSUBSCRIBE: 'msg-notsubscribe',
